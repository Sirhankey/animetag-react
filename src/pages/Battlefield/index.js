...
function Battlefield() {
    ...
    function escolherPokemon(id) {
        ...
        console.log('Escolhendo pokemon', selectedPokemon);
        // console.log(selectedPokemon.sprites.other.showdown.front_default)
    }

    console.log(playerPkmns)
    return (
                ...
                <div className={styles.r_player_side}>
                    <div className={styles.player_pkmns}>
                        {playerPkmns.map((pokemon) => (
                            <div className={styles.player_pkmn}>
